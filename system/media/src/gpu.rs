...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct MediaBuffer { pub id: u64, pub width: u32, pub height: u32, pub format: BufferFormat, pub stride: u32, pub shared: bool }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct DmaBufDescriptor { pub fd: i32, pub size_bytes: u64, pub stride: u32, pub offset: u32 }

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct HardwareOverlay { pub enabled: bool, pub source: BufferFormat, pub z_order: i32 }

impl HardwareOverlay {
    pub const fn supports_format(format: BufferFormat) -> bool { matches!(format, BufferFormat::Nv12 | BufferFormat::Rgba8 | BufferFormat::Bgra8) }
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct DisplayMode { pub width: u32, pub height: u32, pub refresh_hz: u32 }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FramePacer { pub timing: FrameTiming, pub last_present_us: Option<u64> }

impl FramePacer {
    pub const fn new(timing: FrameTiming) -> Self { Self { timing, last_present_us: None } }
    pub fn next_deadline(&self, now_us: u64) -> Option<u64> { self.timing.deadline_us(now_us) }
    pub fn presented(&mut self, timestamp_us: u64) { self.last_present_us = Some(timestamp_us); }
}
