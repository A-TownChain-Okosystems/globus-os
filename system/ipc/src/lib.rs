...
#[derive(Debug, Clone, Copy, PartialEq, Eq)] pub struct MessageHeader { pub endpoint:Endpoint, pub opcode:u32, pub payload_len:u32 }
#[derive(Debug, Clone, PartialEq, Eq)] pub struct Message { pub header:MessageHeader, pub payload:Vec<u8> }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)] #[repr(u32)] pub enum IdentityOpcode { Register=0x0900, Login=0x0901, Logout=0x0902, Lock=0x0903, Recover=0x0904 }
